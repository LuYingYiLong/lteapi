#ifndef NOTE_SKIN_IMPORTER_H
#define NOTE_SKIN_IMPORTER_H
...
namespace godot {
	class LTENoteSkinImporter : public EditorImportPlugin {
		GDCLASS(LTENoteSkinImporter, EditorImportPlugin)
